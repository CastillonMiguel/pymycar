...
diffr =  np.array([0.0, -250.0, 0])
diffl =  -np.array([0.0,-250.0, 0])
...
wheel_right_d = pv.Cylinder(center=coorinate_right_wheel+diffr, direction=direction_right_wheel, height=200, radius=400)
wheel_left_d  = pv.Cylinder(center=coorinate_left_wheel +diffl, direction=direction_left_wheel, height=200, radius=400)
...
plotter.add_mesh(wheel_right, color="black", opacity=0.5)
...
# plotter.add_mesh(wheel_right_d, color="green", opacity=1.0)
# plotter.add_mesh(wheel_left_d , color="green", opacity=1.0)

# plotter.add_mesh(wheel_right_d, color="blue", opacity=1.0)
# plotter.add_mesh(wheel_left_d , color="blue", opacity=1.0)
