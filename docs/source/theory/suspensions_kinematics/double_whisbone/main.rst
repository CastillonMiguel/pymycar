...
.. note::
    For an interactive visualization of the suspension, view the CAD example representation: :ref:`ref_cad_suspension_double_whisbone_base`.
...
.. note::
    For an interactive visualization of the suspension, view the CAD example representation: :ref:`ref_cad_suspension_double_whisbone_configuration_1`.
...
.. note::
    For an interactive visualization of the suspension, view the CAD example representation: :ref:`ref_cad_suspension_double_whisbone_configuration_2`.
